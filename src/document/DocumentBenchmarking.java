...
public class DocumentBenchmarking
{
	...
	public static void main(String[] args)
	{
		...
		for (int numToCheck = start; numToCheck < numSteps * increment + start; numToCheck += increment)
		{
			...
			String currText = getStringFromFile(textFile, numToCheck);
			long startTime;
			long endTime;
			...
			{
				Document doc = new BasicDocument(currText);
			...
			for (int i = 0; i < trials; i++)
			{
				Document doc = new EfficientDocument(currText);
				double score = doc.getFleschScore();
				doc = null;
			}
			endTime = System.nanoTime();
			 ...
			 * 1. Print out numToCheck followed by a tab (\t) (NOT a newline) DONE
			 * 
			 * 2. Read numToCheck characters from the file into a String  DONE
			 ...
			 * 		b. Calls fleschScore on this document 
			 * 
